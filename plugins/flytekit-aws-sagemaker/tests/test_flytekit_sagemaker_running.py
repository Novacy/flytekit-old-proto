...
cmd = [
    "--__FLYTE_ENV_VAR_env1__",
    "val1",
    "--__FLYTE_ENV_VAR_env2__",
    "val2",
    "--__FLYTE_CMD_0_service_venv__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_1_pyflyte-execute__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_2_--task-module__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_3_blah__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_4_--task-name__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_5_bloh__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_6_--output-prefix__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_7_s3://fake-bucket__",
    "__FLYTE_CMD_DUMMY_VALUE__",
    "--__FLYTE_CMD_8_--inputs__",
    "__FLYTE_CMD_DUMMY_VALUE__",
